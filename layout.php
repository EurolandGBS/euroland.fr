...
<html lang="fr">
    <head>
        ...
        <script type="text/javascript" src="./javascript/divbox.js"></script>
        -->
    ...
    <body ng-app="autocompleteDemo" ng-cloak>
        <md-toolbar class="" style="height: 80px; background-color: #444444; top: 0; position: fixed; border-bottom: 1px solid #aacc44;">
            <a href="index.php" title="Accueil"><img src="./images/logogbs.png" style="position: absolute; width: 80; top: 20; left: 20;"></a>
            <form method="post" action="">
                ...
                <!--
                <md-button name="reprog" type="submit" class="md-raised" style="padding: 10px; left: 200px; top: 5px; background-color: #222222; font-weight: bold; color: #aacc44;">Reprographie</md-button>
                ...
                -->
                <a href="https://www.facebook.com/euroland.gbs" style="position: fixed; right: 20px; top: 10px" title="Euroland Facebook"><img src="./images/Facebook.png" width="50px"></a>
            </form>
        </md-toolbar>
        ...
        <md-toolbar class="" style="height: 120px; background-color: #444444; bottom: 0; position: fixed; border-top: 1px solid #aacc44";>
            <div class="footer">
                <div class="footer-left">
                    ...
                    <p style="margin-top: -12px; font-size: 13px;"><a href="mailto:info@euroland.fr">info@euroland.fr</a></p>
                ...
                <div class="footer-right">
                    ...
                    <p style="margin-top: -12px; font-size: 13px;"><a href="mailto:contact@euroland.fr">contact@euroland.fr</a></p>
